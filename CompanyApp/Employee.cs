...
namespace CompanyApp
{
    public class Employee
    {
        ...
        private const string SelectQuery =
            "SELECT e.EmpId, e.EmpName, e.EmpAge, e.EmpContact, e.EmpGender, u.Username AS CreatedByName " +
            "FROM Emp_details e LEFT JOIN Users u ON e.CreatedBy = u.UserID";
        ...
        private const string UpdateQuery =
            "UPDATE Emp_details SET EmpName=@EmpName, EmpAge=@EmpAge, EmpContact=@EmpContact, EmpGender=@EmpGender " +
            "WHERE EmpId=@EmpId";
